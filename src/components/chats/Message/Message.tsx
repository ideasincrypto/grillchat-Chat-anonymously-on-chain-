...
import DefaultMessageVariant from './variants/DefaultMessageVariant'
import EmojiMessageVariant, {
  shouldRenderEmojiMessageVariant,
} from './variants/EmojiMessageVariant'

export type MessageProps = Omit<ComponentProps<'div'>, 'children'> & {
  message: PostData
...
export default function Message({
  ...
  const getMessageMenus = (): CommonCustomContextMenuProps['menus'] => {
  ...
  const menus = withCustomMenu && isSent ? getMessageMenus() : []
  ...
  const isEmojiOnly = shouldRenderEmojiMessageVariant(body)
  const ChatMessageContentVariant = isEmojiOnly
    ? EmojiMessageVariant
    : DefaultMessageVariant
