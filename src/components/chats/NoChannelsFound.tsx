...
import { getSuggestNewChannelLink } from '@/constants/links'
import Image from 'next/image'
import { HiArrowUpRight } from 'react-icons/hi2'

export type NoChannelsFoundProps = {
  search: string
  hubId?: string
}

export default function NoChannelsFound({
  search,
  hubId,
}: NoChannelsFoundProps) {
  return (
    <Container
      as='div'
    ...
    >
      ...
      <Button
        ...
        size='lg'
        href={getSuggestNewChannelLink({ channelName: search, hubId })}
        target='_blank'
