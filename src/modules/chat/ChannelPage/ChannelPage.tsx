...
import ChannelPageNavbarExtension from './ChannelPageNavbarExtension'

const AboutChannelModal = dynamic(
  () => import('@/components/modals/about/AboutChannelModal'),
  {
    ssr: false,
  }
)

type ChannelMetadata = { title: string; body: string; image: string }

export type ChannelPageProps = {
  hubId: string
  chatId?: string
  stubMetadata?: ChannelMetadata
}
